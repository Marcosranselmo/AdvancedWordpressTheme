        ...
        ?>
            ...
            ?>
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="<?php echo esc_url($menu_item->url);  ?>" role="button" data-bs-toggle="dropdown" aria-expanded="false">Dropdown
                ...
                <ul class="dropdown-menu">
                  ...
                  ?>
                  <li><a class="dropdown-item" href="¨<?php echo esc_url( $child_menu_item->url ); ?>">Action
